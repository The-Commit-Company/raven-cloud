...
import { List, Grid3X3, Filter as FilterIcon, Search, Download, Bot, Zap, Bell, FileText, ChevronDown } from "lucide-react"
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-gray-600 mt-1 text-sm">Extend the functionality of your Frappe sites by integrating tools that suit your needs. Seamlessly download in just a few steps.</p>
                        </div>
                        ...
                        <DropdownMenu>
                            <DropdownMenuTrigger asChild>
                                <Button
                                    variant="outline"
                                    size="sm"
                                    className="h-9 w-64 flex items-center justify-between px-3"
                                >
                                    <div className="flex items-center gap-2">
                                        <selectedCategoryObj.icon className="w-4 h-4 mr-2" />
                                ...
                                {data?.length === 0 ? (
                                    <div className="text-center py-12">
                                        ...
                                        <p className="text-gray-500">Try adjusting your search or filter criteria</p>
                                            ...
                                            <div className={viewMode === "grid" ? "grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6" : "grid grid-cols-2 gap-4"}>
                                        {data?.map((item) => {
